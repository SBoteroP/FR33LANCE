...
export function Login() {
  ...
  return (
    <div className="w-full max-w-xs m-auto">
      <h1 className="text-6xl font-extrabold text-transparent bg-gradient-to-r from-green-500 to-teal-500 bg-clip-text tracking-tight mb-10 font-heading">
        FREELANCE
      </h1>
      ...
      >
        <div className="mb-4">
          <label
            htmlFor="email"
            className="block 
          text-gray-777 text-sm font-bold mb-2"
          >
            Email
          </label>
          <input
